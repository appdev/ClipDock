...
The app stores local data at `~/Library/Application Support/ClipboardWorkbench/clipboard.sqlite`. Avoid committing private clipboard data, local databases, screenshots with sensitive content, or ad-hoc release artifacts outside the documented `.codex/artifacts` workflow.
